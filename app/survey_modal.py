...
def render_copy_confirmation():
    ...
    # overflowed the button in the four-equal-column action row. UI-v2g: added
    # a trailing checkmark (a plain Unicode glyph, not an emoji — consistent
    # with the team's de-emoji decision) so the confirmed state reads clearly.
