...
- **Teachable:** Focuses on the core engineering skills required to clean and normalise a messy real-world taxonomy (2,511 raw tool strings → ~24 canonical tools), tune vector retrieval, and enforce deterministic rules ahead of an LLM call — **using plain Python and a local Chroma vector store, not Flowise.**
