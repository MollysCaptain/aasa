...
| **"Who were your testers?"** | 8 practitioners at 7 real companies — payments, music rights, HR tech, coaching, food delivery, e-commerce parts, climate software — 3 heads of function and 5 specialists, 5 non-native English speakers, 5 choosing the regulated posture. Employers and names are withheld in the submitted record: they consented to testing, not to being named. All recruited through our own networks, which is convenience sampling and plausibly inflates trust. Disclosed in Known-Limitations. |
