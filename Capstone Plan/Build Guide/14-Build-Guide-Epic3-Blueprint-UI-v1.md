...
- [x] **Updates E/F/G** (per-tool pricing + pricing-type toggle in Block A, case-count toggle + "Stack used" line in Block C, "How the recommendation is made" section — see `22-Build-Guide-Updates-Epic3-v1.md`): unit-verified, **live Streamlit re-test still pending** — see `23-Build-Guide-Epic3-UI-Verification-v1.md`.
